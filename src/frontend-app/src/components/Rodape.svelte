...
<Footer footerType="logo" class="bg-green-900 fixed bottom-0 left-0 w-full">
    <div class="sm:flex sm:items-center sm:justify-between self-center text-xl font-semibold whitespace-nowrap text-green-200 dark:text-white">
      ...
      <FooterLinkGroup class="mb-6 flex flex-wrap items-center text-lg font-bold px-4 py-2 text-gray-300">
        ...
        <FooterLink href="https://github.com/cp2-dc-info-projeto-final/the-green-cup">Github</FooterLink>
      </FooterLinkGroup>
    </div>
    <hr class="my-6 bg-green-900 sm:mx-auto lg:my-8 dark:border-green-900" />
    <FooterCopyright class="items-center text-lg text-gray-300" href="/" by="The Green Cup™" />
</Footer>
