...
<div>
    <div class="text-center pt-32">
        ...
        <div class="grid grid-flow-col justify-items-center ">
            <img class="h-auto max-w-full rounded-lg shadow-xl" src="https://primeirapagina.com.br/wp-content/uploads/2024/12/Capivara-dormindo.jpg" alt="image description">
        </div> 
</div>
<div class="">
    <a class="text-center">
    ...
    <p class="pt-8 text-center font-normal text-gray-700 dark:text-gray-400">O Brasil abriga uma das maiores biodiversidades do planeta, com ecossistemas únicos e espécies que só existem aqui. No entanto, essa riqueza natural está constantemente ameaçada pelo desmatamento, pela poluição e por ações humanas que colocam em risco o equilíbrio ambiental.
        ...
        <p class="text-center font-normal text-gray-700 dark:text-gray-400">🌿🐆🌎 Seja a mudança que o nosso planeta precisa!🌎🐆🌿</p>
