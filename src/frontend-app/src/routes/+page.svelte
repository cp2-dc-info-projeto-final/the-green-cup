...
<svelte:head>
 ...
 <section class="md:bg-no-repeat md:bg-[url('nhacare.jpeg')] md:bg-top md:bg-gray-700 md:bg-blend-multiply bg-[url('lacoste.avif')] bg-center bg-no-repeat">
            ...
            <div class="w-full bg-white col-1 md:col-1 md:pr-12 ">
                ...
                <div class="col-span-2 pb-8">
                    <a href="https://institutoterra.org/">
                        <img src="InstitutoTerra.jpg" alt=""> 
                    </a>    
                </div>
                ...
                <div class="w-full bg-white md:col-1">
                    ...
                    <div class="col-span-2 pb-8">
                        <a href="https://www.tnc.org.br/">
                            <img src="/NATURE_CONSERVANCY.jpg" alt=""> 
                        </a>  
                    </div>
                </div>
            </div>
